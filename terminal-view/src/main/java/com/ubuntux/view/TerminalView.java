...
import com.ubuntux.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
     ...
     * {@link com.ubuntux.terminal.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mTextSelectionCursorController != null) {
            ...
            // android.view.WindowLeaked: Activity com.ubuntux.app.UbuntuxActivity has leaked window android.widget.PopupWindow
            stopTextSelectionMode();
