...
import com.ubuntux.shared.ubuntux.shell.TermuxShellUtils;
...
public final class TermuxService extends Service implements AppShell.AppShellClient, TermuxSession.TermuxSessionClient {
    ...
    /** If {@link UbuntuxActivity} has not bound to the {@link TermuxService} yet or is destroyed, then
     ...
     *
     * @return Returns the {@link TermuxTerminalSessionActivityClient} if {@link UbuntuxActivity} has bound with
