...
import com.ubuntux.shared.ubuntux.terminal.io.BellHandler;
import com.ubuntux.shared.logger.Logger;
import com.ubuntux.terminal.TerminalColors;
import com.ubuntux.terminal.TerminalSession;
import com.ubuntux.terminal.TerminalSessionClient;
import com.ubuntux.terminal.TextStyle;
...
public class UbuntuxTerminalSessionActivityClient extends UbuntuxTerminalSessionClientBase {

    private final UbuntuxActivity mActivity;
    ...
    private static final String LOG_TAG = "UbuntuxTerminalSessionActivityClient";

    public UbuntuxTerminalSessionActivityClient(UbuntuxActivity activity) {
    ...
    public void onSessionFinished(@NonNull TerminalSession finishedSession) {
        UbuntuxService service = mActivity.getTermuxService();
        ...
        UbuntuxSession termuxSession = service.getTermuxSession(index);
    ...
    public void onBell(@NonNull TerminalSession session) {
        ...
        switch (mActivity.getProperties().getBellBehaviour()) {
            case UbuntuxPropertyConstants.IVALUE_BELL_BEHAVIOUR_VIBRATE:
                BellHandler.getInstance(mActivity).doBell();
                break;
            case UbuntuxPropertyConstants.IVALUE_BELL_BEHAVIOUR_BEEP:
                loadBellSoundPool();
                if (mBellSoundPool != null)
                    mBellSoundPool.play(mBellSoundId, 1.f, 1.f, 1, 0, 1.f);
                break;
            case UbuntuxPropertyConstants.IVALUE_BELL_BEHAVIOUR_IGNORE:
    ...
    public void setTerminalShellPid(@NonNull TerminalSession terminalSession, int pid) {
        ...
        UbuntuxSession termuxSession = service.getTermuxSessionForTerminalSession(terminalSession);
        if (termuxSession != null)
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.ubuntux/com.ubuntux.app.UbuntuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
    ...
    private void renameSession(TerminalSession sessionToRename, String text) {
        ...
        UbuntuxService service = mActivity.getTermuxService();
        if (service != null) {
            UbuntuxSession termuxSession = service.getTermuxSessionForTerminalSession(sessionToRename);
            if (termuxSession != null)
    ...
    public void addNewSession(boolean isFailSafe, String sessionName) {
        ...
        if (service.getTermuxSessionsSize() >= MAX_SESSIONS) {
            ...
            UbuntuxSession newTermuxSession = service.createTermuxSession(null, null, null, workingDirectory, isFailSafe, sessionName);
    ...
    public TerminalSession getCurrentStoredSessionOrLast() {
        ...
        if (stored != null) {
            ...
            UbuntuxSession termuxSession = service.getLastTermuxSession();
            if (termuxSession != null)
    ...
    public void checkForFontAndColors() {
        try {
            File colorsFile = UbuntuxConstants.UBUNTUX_COLOR_PROPERTIES_FILE;
            File fontFile = UbuntuxConstants.UBUNTUX_FONT_FILE;
