 ...
 * instead of the default `InputType.TYPE_NULL` for ubuntux, some keyboards may still show suggestions.
 ...
 * like number row, etc.
 *
 * To fix these issues, `activity_ubuntux.xml` has the constant 1sp transparent
 * `activity_ubuntux_bottom_space_view` View at the bottom. This will appear as a line matching the
 * activity theme. When {@link UbuntuxActivity} {@link ViewTreeObserver.OnGlobalLayoutListener} is
 ...
 */
public class UbuntuxActivityRootView extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {

    public UbuntuxActivity mActivity;
    ...
    private static final String LOG_TAG = "UbuntuxActivityRootView";

    private static int mStatusBarHeight;

    public UbuntuxActivityRootView(Context context) {
        super(context);
    }

    public UbuntuxActivityRootView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public UbuntuxActivityRootView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public void setActivity(UbuntuxActivity activity) {
        mActivity = activity;
    }
    ...
    public void onGlobalLayout() {
        ...
        View bottomSpaceView = mActivity.getUbuntuxActivityBottomSpaceView();
        ...
        if (isVisible) {
            ...
            // Calling addUbuntuxActivityRootViewGlobalLayoutListener with a delay fails to
