...
import com.ubuntux.shared.ubuntux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
...
import com.ubuntux.view.TerminalViewClient;
...
public final class UbuntuxActivity extends AppCompatActivity implements ServiceConnection {
     ...
     */
    UbuntuxActivityRootView mUbuntuxActivityRootView;

    /**
     * The space at the bottom of {@link @mUbuntuxActivityRootView} of the {@link UbuntuxActivity}.
     */
    View mUbuntuxActivityBottomSpaceView;
     ...
     */
    private final BroadcastReceiver mUbuntuxActivityBroadcastReceiver = new UbuntuxActivityBroadcastReceiver();
    ...
    /**
     * The {@link UbuntuxActivity} is in an invalid state and must not be run.
     */
    ...
    private static final String LOG_TAG = "UbuntuxActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUbuntuxActivityRootView = findViewById(R.id.activity_ubuntux_root_view);
        mUbuntuxActivityRootView.setActivity(this);
        mUbuntuxActivityBottomSpaceView = findViewById(R.id.activity_ubuntux_bottom_space_view);
        mUbuntuxActivityRootView.setOnApplyWindowInsetsListener(new UbuntuxActivityRootView.WindowInsetsListener());
    ...
    public void onStart() {
        ...
        if (mPreferences.isTerminalMarginAdjustmentEnabled())
            addUbuntuxActivityRootViewGlobalLayoutListener();

        registerUbuntuxActivityBroadcastReceiver();
    }
    ...
    protected void onStop() {
        ...
        removeUbuntuxActivityRootViewGlobalLayoutListener();

        unregisterUbuntuxActivityBroadcastReceiver();
    ...
    private void setMargins() {
        RelativeLayout relativeLayout = findViewById(R.id.activity_ubuntux_root_relative_layout);
    ...
    public void addUbuntuxActivityRootViewGlobalLayoutListener() {
        getUbuntuxActivityRootView().getViewTreeObserver().addOnGlobalLayoutListener(getUbuntuxActivityRootView());
    }

    public void removeUbuntuxActivityRootViewGlobalLayoutListener() {
        if (getUbuntuxActivityRootView() != null)
            getUbuntuxActivityRootView().getViewTreeObserver().removeOnGlobalLayoutListener(getUbuntuxActivityRootView());
    }
    ...
    private void setNewSessionButtonView() {
        ...
        newSessionButton.setOnLongClickListener(v -> {
            TextInputDialogUtils.textInput(UbuntuxActivity.this, R.string.title_create_named_session, null,
    ...
    public void finishActivityIfNotFinishing() {
        ...
        if (!UbuntuxActivity.this.isFinishing()) {
            finish();
        }
    }
    ...
    public void showToast(String text, boolean longDuration) {
        ...
        mLastToast = Toast.makeText(UbuntuxActivity.this, text, longDuration ? Toast.LENGTH_LONG : Toast.LENGTH_SHORT);
    ...
    public UbuntuxActivityRootView getUbuntuxActivityRootView() {
        return mUbuntuxActivityRootView;
    }

    public View getUbuntuxActivityBottomSpaceView() {
        return mUbuntuxActivityBottomSpaceView;
    }
    ...
    private void unregisterUbuntuxActivityBroadcastReceiver() {
        unregisterReceiver(mUbuntuxActivityBroadcastReceiver);
    }
    ...
    class UbuntuxActivityBroadcastReceiver extends BroadcastReceiver {
        @Override
    ...
    private void reloadActivityStyling(boolean recreateActivity) {
        ...
        if (recreateActivity) {
            ...
            UbuntuxActivity.this.recreate();
        }
    }



    public static void startUbuntuxActivity(@NonNull final Context context) {
        ActivityUtils.startActivity(context, newInstance(context));
    }

    public static Intent newInstance(@NonNull final Context context) {
        Intent intent = new Intent(context, UbuntuxActivity.class);
