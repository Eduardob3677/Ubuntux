...
public class UbuntuxOpenReceiver extends BroadcastReceiver {

    private static final String LOG_TAG = "UbuntuxOpenReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Uri uriToShare = UriUtils.getContentUri(UbuntuxConstants.UBUNTUX_FILE_SHARE_URI_AUTHORITY, fileToShare.getAbsolutePath());
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
            ...
            try {
                ...
                if (!(path.startsWith(UbuntuxConstants.UBUNTUX_FILES_DIR_PATH) || path.startsWith(storagePath))) {
                    throw new IllegalArgumentException("Invalid path: " + path);
                }

                // If UbuntuxConstants.PROP_ALLOW_EXTERNAL_APPS property to not set to "true", then throw exception
                ...
                // UbuntuxConstants.PROP_ALLOW_EXTERNAL_APPS set by users without their explicit consent.
                if (UbuntuxConstants.UBUNTUX_PROPERTIES_FILE_PATHS_LIST.contains(path) ||
                    UbuntuxConstants.UBUNTUX_FLOAT_PROPERTIES_FILE_PATHS_LIST.contains(path)) {
                    mode = "r";
                }
