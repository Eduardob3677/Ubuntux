package com.ubuntux.shared.ubuntux.shell;
...
public class UbuntuxShellManager {

    private static UbuntuxShellManager shellManager;
     ...
     * Note that this list is observed by an activity, like UbuntuxActivity.mTermuxSessionListViewController,
     * so any changes must be made on the UI thread and followed by a call to
     * {@link ArrayAdapter#notifyDataSetChanged()}.
     */
    public final List<UbuntuxSession> mTermuxSessions = new ArrayList<>();
    ...
    public UbuntuxShellManager(@NonNull Context context) {
     ...
     * @return Returns the {@link UbuntuxShellManager}.
     */
    public static UbuntuxShellManager init(@NonNull Context context) {
        if (shellManager == null)
            shellManager = new UbuntuxShellManager(context);
     ...
     * @return Returns the {@link UbuntuxShellManager}.
     */
    public static UbuntuxShellManager getShellManager() {
        return shellManager;
    }
