 ...
 *
 * - 0.2.0 (2021-03-11)
 *      - Renamed `HOME_PATH` to `UBUNTUX_HOME_DIR_PATH`.
 *      - Renamed `UBUNTUX_PROPERTIES_PRIMARY_PATH` to `UBUNTUX_PROPERTIES_PRIMARY_FILE_PATH`.
 *      - Renamed `UBUNTUX_PROPERTIES_SECONDARY_FILE_PATH` to `UBUNTUX_PROPERTIES_SECONDARY_FILE_PATH`.
 *
 * - 0.3.0 (2021-03-16)
 ...
 * {@link UbuntuxConstants#UBUNTUX_PROPERTIES_PRIMARY_FILE_PATH} or
 * {@link UbuntuxConstants#UBUNTUX_PROPERTIES_SECONDARY_FILE_PATH}
 */
public final class UbuntuxPropertyConstants {

    private static final String LOG_TAG = "UbuntuxPropertyConstants";
    ...
    /** Defines the key for whether the {@link UbuntuxAmSocketServer} should be run at app startup */
    ...
    public static final String DEFAULT_IVALUE_DEFAULT_WORKING_DIRECTORY = UbuntuxConstants.UBUNTUX_HOME_DIR_PATH;
     ...
     * */
    public static final Set<String> UBUNTUX_APP_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        /* boolean */
        ...
        UbuntuxConstants.PROP_ALLOW_EXTERNAL_APPS,
     ...
     * default: false
     */
    public static final Set<String> UBUNTUX_DEFAULT_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        KEY_DISABLE_FILE_SHARE_RECEIVER,
        KEY_DISABLE_FILE_VIEW_RECEIVER,
        KEY_DISABLE_HARDWARE_KEYBOARD_SHORTCUTS,
        KEY_DISABLE_TERMINAL_SESSION_CHANGE_TOAST,
     ...
     * default: true
     */
    public static final Set<String> UBUNTUX_DEFAULT_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        KEY_EXTRA_KEYS_TEXT_ALL_CAPS,
        KEY_RUN_TERMUX_AM_SOCKET_SERVER
    ));
     ...
     * default: false
     */
    public static final Set<String> UBUNTUX_DEFAULT_INVERETED_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
    ));
     ...
     * default: true
     */
    public static final Set<String> UBUNTUX_DEFAULT_INVERETED_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
    ));
