 ...
 *          Termux app and its plugins. This will allow {@link com.ubuntux.app.TermuxSettings} to
 ...
 *      - Added following to `UBUNTUX_TASKER_APP`:
 *           `KEY_LOG_LEVEL`.
 *
 * - 0.4.0 (2021-03-13)
 *      - Added following to `UBUNTUX_APP`:
 ...
 *
 * - 0.6.0 (2021-03-24)
 *      - Change `DEFAULT_VALUE_KEEP_SCREEN_ON` value to `false` in `UBUNTUX_APP`.
 *
 * - 0.7.0 (2021-03-27)
 *      - Added following to `UBUNTUX_APP`:
 ...
 *
 * - 0.12.0 (2021-08-27)
 *      - Added `UBUNTUX_API_APP.KEY_LOG_LEVEL`, `UBUNTUX_BOOT_APP.KEY_LOG_LEVEL`,
 *          `UBUNTUX_FLOAT_APP.KEY_LOG_LEVEL`, `UBUNTUX_STYLING_APP.KEY_LOG_LEVEL`,
 *          `UBUNTUX_Widget_APP.KEY_LOG_LEVEL`.
 *
 * - 0.13.0 (2021-09-02)
 *      - Added following to `UBUNTUX_FLOAT_APP`:
 *          `KEY_WINDOW_X`, `KEY_WINDOW_Y`, `KEY_WINDOW_WIDTH`, `KEY_WINDOW_HEIGHT`, `KEY_FONTSIZE`,
 *          `KEY_TERMINAL_VIEW_KEY_LOGGING_ENABLED`.
 *
 * - 0.14.0 (2021-09-04)
 *      - Added `UBUNTUX_WIDGET_APP.KEY_TOKEN`.
 *
 * - 0.15.0 (2021-09-05)
 *      - Added following to `UBUNTUX_TASKER_APP`:
 ...
 */
public final class UbuntuxPreferenceConstants {
     ...
     */
    public static final class UBUNTUX_API_APP {
    ...
    /**
     * Ubuntux:Boot app constants.
     */
    public static final class UBUNTUX_BOOT_APP {
     ...
     */
    public static final class UBUNTUX_STYLING_APP {
     ...
     */
    public static final class UBUNTUX_TASKER_APP {
     ...
     */
    public static final class UBUNTUX_WIDGET_APP {
