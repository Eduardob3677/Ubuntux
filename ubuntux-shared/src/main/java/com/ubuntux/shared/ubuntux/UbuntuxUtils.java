...
import com.ubuntux.shared.reflection.ReflectionUtils;
...
public class UbuntuxUtils {
    ...
    public enum AppInfoMode {
        ...
        UBUNTUX_AND_PLUGIN_PACKAGE,
        /** Get info for Termux app and its plugins listed in {@link UbuntuxConstants#UBUNTUX_PLUGIN_APP_PACKAGE_NAMES_LIST}. */
        UBUNTUX_AND_PLUGIN_PACKAGES,
        /* Get info for all the Termux app plugins listed in {@link UbuntuxConstants#UBUNTUX_PLUGIN_APP_PACKAGE_NAMES_LIST}. */
        UBUNTUX_PLUGIN_PACKAGES,
        /* Get info for Termux app and the calling package that called a Termux API. */
        UBUNTUX_AND_CALLING_PACKAGE,
    }

    private static final String LOG_TAG = "UbuntuxUtils";

    /**
     * Get the {@link Context} for {@link UbuntuxConstants#UBUNTUX_PACKAGE_NAME} package with the
    ...
    public static Context getTermuxPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, UbuntuxConstants.UBUNTUX_PACKAGE_NAME);
    }
    ...
    public static Context getTermuxPackageContextWithCode(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, UbuntuxConstants.UBUNTUX_PACKAGE_NAME, Context.CONTEXT_INCLUDE_CODE);
    }

    /**
     * Get the {@link Context} for {@link UbuntuxConstants#UBUNTUX_API_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxAPIPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, UbuntuxConstants.UBUNTUX_API_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link UbuntuxConstants#UBUNTUX_BOOT_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxBootPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, UbuntuxConstants.UBUNTUX_BOOT_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link UbuntuxConstants#UBUNTUX_FLOAT_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxFloatPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, UbuntuxConstants.UBUNTUX_FLOAT_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link UbuntuxConstants#UBUNTUX_STYLING_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxStylingPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, UbuntuxConstants.UBUNTUX_STYLING_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link UbuntuxConstants#UBUNTUX_TASKER_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxTaskerPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, UbuntuxConstants.UBUNTUX_TASKER_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link UbuntuxConstants#UBUNTUX_WIDGET_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxWidgetPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, UbuntuxConstants.UBUNTUX_WIDGET_PACKAGE_NAME);
    }
    ...
    public static Context getContextForPackageOrExitApp(@NonNull Context context, String packageName,
        ...
        return PackageUtils.getContextForPackageOrExitApp(context, packageName, exitAppOnError, UbuntuxConstants.UBUNTUX_GITHUB_REPO_URL);
    }
     ...
     * @return Returns {@code errmsg} if {@link UbuntuxConstants#UBUNTUX_PACKAGE_NAME} is not installed
     * or disabled, otherwise {@code null}.
     */
    public static String isTermuxAppInstalled(@NonNull final Context context) {
        return PackageUtils.isAppInstalled(context, UbuntuxConstants.UBUNTUX_APP_NAME, UbuntuxConstants.UBUNTUX_PACKAGE_NAME);
    }
     ...
     *
     * @param context The context for operations.
     * @return Returns {@code errmsg} if {@link UbuntuxConstants#UBUNTUX_API_PACKAGE_NAME} is not installed
     * or disabled, otherwise {@code null}.
     */
    public static String isTermuxAPIAppInstalled(@NonNull final Context context) {
        return PackageUtils.isAppInstalled(context, UbuntuxConstants.UBUNTUX_API_APP_NAME, UbuntuxConstants.UBUNTUX_API_PACKAGE_NAME);
    }
     ...
     * {@link UbuntuxConstants#UBUNTUX_PACKAGE_NAME} and then if
     * {@link UbuntuxConstants#UBUNTUX_PREFIX_DIR_PATH} exists and has
     ...
     * {@link UbuntuxConstants#UBUNTUX_PREFIX_DIR_PATH} is accessible, otherwise {@code null}.
     */
    public static String isTermuxAppAccessible(@NonNull final Context currentPackageContext) {
        ...
        if (errmsg == null) {
            ...
            if (errmsg == null) {
                // If UbuntuxConstants.UBUNTUX_PREFIX_DIR_PATH is not a directory or does not have required permissions
                Error error = UbuntuxFileUtils.isTermuxPrefixDirectoryAccessible(false, false);
                if (error != null)
    ...
    /**
     * Get a field value from the {@link UBUNTUX_APP#BUILD_CONFIG_CLASS_NAME} class of the Termux app
    ...
    public static Object getTermuxAppAPKBuildConfigClassField(@NonNull Context currentPackageContext,
        ...
        return getTermuxAppAPKClassField(currentPackageContext, UBUNTUX_APP.BUILD_CONFIG_CLASS_NAME, fieldName);
    }
    ...
    public static Object getTermuxAppAPKClassField(@NonNull Context currentPackageContext,
        ...
        try {
            Context termuxPackageContext = UbuntuxUtils.getTermuxPackageContextWithCode(currentPackageContext);
            if (termuxPackageContext == null)
                return null;
    ...
    /** Returns {@code true} if {@link Uri} has `package:` scheme for {@link UbuntuxConstants#UBUNTUX_PACKAGE_NAME} or its sub plugin package. */
    public static boolean isUriDataForTermuxOrPluginPackage(@NonNull Uri data) {
        return data.toString().equals("package:" + UbuntuxConstants.UBUNTUX_PACKAGE_NAME) ||
            data.toString().startsWith("package:" + UbuntuxConstants.UBUNTUX_PACKAGE_NAME + ".");
    }

    /** Returns {@code true} if {@link Uri} has `package:` scheme for {@link UbuntuxConstants#UBUNTUX_PACKAGE_NAME} sub plugin package. */
    public static boolean isUriDataForTermuxPluginPackage(@NonNull Uri data) {
        return data.toString().startsWith("package:" + UbuntuxConstants.UBUNTUX_PACKAGE_NAME + ".");
    }
    ...
    public static void sendTermuxOpenedBroadcast(@NonNull Context context) {
        Intent broadcast = new Intent(UbuntuxConstants.BROADCAST_TERMUX_OPENED);
    ...
    public static String getAppInfoMarkdownString(final Context currentPackageContext, final AppInfoMode appInfoMode, @Nullable String callingPackageName) {
        ...
        switch (appInfoMode) {
            case UBUNTUX_PACKAGE:
                return getAppInfoMarkdownString(currentPackageContext, false);

            case UBUNTUX_AND_PLUGIN_PACKAGE:
                return getAppInfoMarkdownString(currentPackageContext, true);

            case UBUNTUX_AND_PLUGIN_PACKAGES:
                appInfo.append(UbuntuxUtils.getAppInfoMarkdownString(currentPackageContext, false));

                String termuxPluginAppsInfo =  UbuntuxUtils.getTermuxPluginAppsInfoMarkdownString(currentPackageContext);
                if (termuxPluginAppsInfo != null)
                    appInfo.append("\n\n").append(termuxPluginAppsInfo);
                return appInfo.toString();

            case UBUNTUX_PLUGIN_PACKAGES:
                return UbuntuxUtils.getTermuxPluginAppsInfoMarkdownString(currentPackageContext);

            case UBUNTUX_AND_CALLING_PACKAGE:
                appInfo.append(UbuntuxUtils.getAppInfoMarkdownString(currentPackageContext, false));
                if (!DataUtils.isNullOrEmpty(callingPackageName)) {
                    String callingPackageAppInfo = null;
                    if (UbuntuxConstants.UBUNTUX_PLUGIN_APP_PACKAGE_NAMES_LIST.contains(callingPackageName)) {
    ...
    public static String getTermuxPluginAppsInfoMarkdownString(final Context currentPackageContext) {
        ...
        List<String> termuxPluginAppPackageNamesList = UbuntuxConstants.UBUNTUX_PLUGIN_APP_PACKAGE_NAMES_LIST;
     ...
     * from the {@link UbuntuxConstants#UBUNTUX_PACKAGE_NAME} package context, then this function
     ...
     * {@link UbuntuxConstants#UBUNTUX_PACKAGE_NAME} package as well if its different from current package.
     * @return Returns the markdown {@link String}.
     */
    ...
    public static String getAppInfoMarkdownStringInner(@NonNull final Context context) {
        ...
        if (context.getPackageName().equals(UbuntuxConstants.UBUNTUX_PACKAGE_NAME)) {
            AndroidUtils.appendPropertyToMarkdown(markdownString, "UBUNTUX_APP_PACKAGE_MANAGER", UbuntuxBootstrap.UBUNTUX_APP_PACKAGE_MANAGER);
            AndroidUtils.appendPropertyToMarkdown(markdownString, "UBUNTUX_APP_PACKAGE_VARIANT", UbuntuxBootstrap.UBUNTUX_APP_PACKAGE_VARIANT);
        }

        Error error;
        error = UbuntuxFileUtils.isTermuxFilesDirectoryAccessible(context, true, true);
        if (error != null) {
            AndroidUtils.appendPropertyToMarkdown(markdownString, "UBUNTUX_FILES_DIR", UbuntuxConstants.UBUNTUX_FILES_DIR_PATH);
    ...
    public static String getReportIssueMarkdownString(@NonNull final Context context) {
        ...
        markdownString.append("\n\n").append(context.getString(R.string.msg_report_issue, UbuntuxConstants.UBUNTUX_WIKI_URL)).append("\n");

        markdownString.append("\n\n### Email\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_SUPPORT_EMAIL_URL, UbuntuxConstants.UBUNTUX_SUPPORT_EMAIL_MAILTO_URL)).append("  ");

        markdownString.append("\n\n### Reddit\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_REDDIT_SUBREDDIT, UbuntuxConstants.UBUNTUX_REDDIT_SUBREDDIT_URL)).append("  ");

        markdownString.append("\n\n### GitHub Issues for Termux apps\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_APP_NAME, UbuntuxConstants.UBUNTUX_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_API_APP_NAME, UbuntuxConstants.UBUNTUX_API_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_BOOT_APP_NAME, UbuntuxConstants.UBUNTUX_BOOT_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_FLOAT_APP_NAME, UbuntuxConstants.UBUNTUX_FLOAT_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_STYLING_APP_NAME, UbuntuxConstants.UBUNTUX_STYLING_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_TASKER_APP_NAME, UbuntuxConstants.UBUNTUX_TASKER_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_WIDGET_APP_NAME, UbuntuxConstants.UBUNTUX_WIDGET_GITHUB_ISSUES_REPO_URL)).append("  ");

        markdownString.append("\n\n### GitHub Issues for Termux packages\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_PACKAGES_GITHUB_REPO_NAME, UbuntuxConstants.UBUNTUX_PACKAGES_GITHUB_ISSUES_REPO_URL)).append("  ");
    ...
    public static String getImportantLinksMarkdownString(@NonNull final Context context) {
        ...
        markdownString.append("\n\n### GitHub\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_APP_NAME, UbuntuxConstants.UBUNTUX_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_API_APP_NAME, UbuntuxConstants.UBUNTUX_API_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_BOOT_APP_NAME, UbuntuxConstants.UBUNTUX_BOOT_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_FLOAT_APP_NAME, UbuntuxConstants.UBUNTUX_FLOAT_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_STYLING_APP_NAME, UbuntuxConstants.UBUNTUX_STYLING_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_TASKER_APP_NAME, UbuntuxConstants.UBUNTUX_TASKER_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_WIDGET_APP_NAME, UbuntuxConstants.UBUNTUX_WIDGET_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_PACKAGES_GITHUB_REPO_NAME, UbuntuxConstants.UBUNTUX_PACKAGES_GITHUB_REPO_URL)).append("  ");
        ...
        markdownString.append("\n\n### Wiki\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_WIKI, UbuntuxConstants.UBUNTUX_WIKI_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_APP_NAME, UbuntuxConstants.UBUNTUX_GITHUB_WIKI_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(UbuntuxConstants.UBUNTUX_PACKAGES_GITHUB_REPO_NAME, UbuntuxConstants.UBUNTUX_PACKAGES_GITHUB_WIKI_REPO_URL)).append("  ");
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.ubuntux.shared.R.raw.apt_info_script);
        try {
        ...
        aptInfoScript = aptInfoScript.replaceAll(Pattern.quote("@UBUNTUX_PREFIX@"), UbuntuxConstants.UBUNTUX_PREFIX_DIR_PATH);

        ExecutionCommand executionCommand = new ExecutionCommand(-1,
            UbuntuxConstants.UBUNTUX_BIN_PREFIX_DIR_PATH + "/bash", null, aptInfoScript,
            null, ExecutionCommand.Runner.APP_SHELL.getName(), false);
        executionCommand.commandLabel = "APT Info Command";
        executionCommand.backgroundCustomLogLevel = Logger.LOG_LEVEL_OFF;
        AppShell appShell = AppShell.execute(context, executionCommand, null, new UbuntuxShellEnvironment(), null, true);
        ...
        markdownString.append("## ").append(UbuntuxConstants.UBUNTUX_APP_NAME).append(" APT Info\n\n");
    ...
    public static String getTermuxDebugMarkdownString(@NonNull final Context context) {
        String statInfo = UbuntuxFileUtils.getTermuxFilesStatMarkdownString(context);
    ...
    public static String getAPKRelease(String signingCertificateSHA256Digest) {
        ...
        switch (signingCertificateSHA256Digest.toUpperCase()) {
            case UbuntuxConstants.APK_RELEASE_FDROID_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return UbuntuxConstants.APK_RELEASE_FDROID;
            case UbuntuxConstants.APK_RELEASE_GITHUB_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return UbuntuxConstants.APK_RELEASE_GITHUB;
            case UbuntuxConstants.APK_RELEASE_GOOGLE_PLAYSTORE_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return UbuntuxConstants.APK_RELEASE_GOOGLE_PLAYSTORE;
            case UbuntuxConstants.APK_RELEASE_TERMUX_DEVS_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return UbuntuxConstants.APK_RELEASE_TERMUX_DEVS;
            default:
                return "Unknown";
        }
    }
    ...
    /**
     * Get a process id of the main app process of the {@link UbuntuxConstants#UBUNTUX_PACKAGE_NAME}
     * package.
     *
     * @param context The context for operations.
    ...
    public static String getTermuxAppPID(final Context context) {
        return PackageUtils.getPackagePID(context, UbuntuxConstants.UBUNTUX_PACKAGE_NAME);
    }
